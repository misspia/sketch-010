...
export class Line {
  constructor({ width, height, color, isInteractable }) {
    ...
    this.maxNoise = new THREE.Vector3(
      randomFloatBetween(1.5, 2),
      randomFloatBetween(1, 2),
      randomFloatBetween(8, 10),
    );
    this.noiseIncrement = new THREE.Vector3(
      randomFloatBetween(0.05, 0.1),
      randomFloatBetween(0.05, 0.1),
      randomFloatBetween(0.5, 1),
    );
    ...
    this.amp = 0;
    this.maxAmp = randomFloatBetween(1.7, 2);
    this.ampIncrement = randomFloatBetween(0.01, 0.05);
